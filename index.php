  ...
  <section id="hero">
    <div class="hero-container">
      <div class="wow fadeIn">
        <div class="hero-logo">
          <img class="" src="logo.png" alt="Imperial">
        </div>

        <h1>Welcome to Imperial Banking</h1>
        <h2>We provide <span class="rotating">fast service, low brokerage, fast applications</span></h2>
        <div class="actions">
          <button onclick="location.href = 'loginpage.php';">Login</button>
          <button onclick="location.href = 'create_account_page.php';">Register</button>
        </div>
      </div>
    </div>
  </section>
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <a href="#hero"><img src="logo.png" alt="" title="" /></img></a>
